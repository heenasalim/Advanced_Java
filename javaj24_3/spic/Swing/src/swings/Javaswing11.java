		...
		{              ////////***********
			//System.out.println("hiee");
			 String   name=tf.getText();
			 {
			  ...
			  if(name!=null && (name.equals(name.toUpperCase()) && ls1!=null &&  ls2!=null))
			      
				   JOptionPane.showMessageDialog(b1, "USER   is  successfully   REGISTERED");
	  ...
	  if(e.getSource()==a)
	   {
	      ...
	      if(e.getSource()==b)
	    {
		String  s2=(String) ls2.getSelectedItem();
		ls2.remove(s2);
		 // ls2.clear();
		}
