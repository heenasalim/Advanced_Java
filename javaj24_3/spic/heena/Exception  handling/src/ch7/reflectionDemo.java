  ...
  public static void main(String[] args) throws Exception
  {
	 ...
	 for(int  i=0;i<f.length;i++)
	  ...
	  Method  m1[]=c.getDeclaredMethods();    //getting  fields 
		...
		{
			System.out.println("the  methods   are:"+m1[i]);
		}
		 Constructor   m2[]=c.getDeclaredConstructors();  //getting  copnstructor  
		 for(int  i=0;i<m2.length;i++)
		{
			System.out.println("the   instance  without  new  keyword   are:"+m2[i]);
		}
